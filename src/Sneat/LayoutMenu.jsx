export default function LayoutMenu(){
    return<>
      <aside id="layout-menu" className="layout-menu menu-vertical menu" style={{"touch-action": "none", "user-select": "none"}}>
                    ...
                    <g id="Brand-Logo" transform="translate(-27.000000, -15.000000)">
                      <g id="Icon" transform="translate(27.000000, 15.000000)">
                        <g id="Mask" transform="translate(0.000000, 8.000000)">
                          ...
                          <use fill="currentColor" ل="#path-1"></use>
                          <g id="Path-3" mask="url(#mask-2)">
                            <use fill="currentColor" href="#path-3"></use>
                            <use fill-opacity="0.2" fill="#FFFFFF" href="#path-3"></use>
                          </g>
                          <g id="Path-4" mask="url(#mask-2)">
                            <use fill="currentColor" href="#path-4"></use>
                            <use fill-opacity="0.2" fill="#FFFFFF" href="#path-4"></use>
                          </g>
                        </g>
                        <g id="Triangle" transform="translate(19.000000, 11.000000) rotate(-300.000000) translate(-19.000000, -11.000000) ">
                          <use fill="currentColor" href="#path-5"></use>
        ...
        <ul className="menu-inner py-1 ps ps--active-y">
          ...
          <li className="menu-item active open">
            <a href="javascript:void(0);" className="menu-link menu-toggle">
              <i className="menu-icon icon-base bx bx-cart-alt"></i>
              <div data-i18n="eCommerce">eCommerce</div>
            </a>
            <ul className="menu-sub">
              <li className="menu-item active">
          ...
          <li className="menu-item">
            <a href="javascript:void(0);" className="menu-link menu-toggle">
              <i className="menu-icon icon-base bx bx-spreadsheet"></i>
          ...
          <div className="ps__rail-x" style={{left: "0px", bottom: "0px"}}><div className="ps__thumb-x" tabindex="0" style={{left: "0px", width: "0px"}}></div></div><div className="ps__rail-y" style={{top: "0px", height: "338px", right: "4px"}}><div className="ps__thumb-y" tabindex="0" style={{top: "0px", height: "54px"}}></div></div></ul>
      </aside>
    </>
}