        ...
        <div id="right-sidebar" className="settings-panel">
            ...
            <div className="tab-content" id="setting-content">
                <div className="tab-pane fade show active scroll-wrapper ps ps--active-y" id="todo-section" role="tabpanel" aria-labelledby="todo-section">
                    ...
                    <div className="ps__rail-x" style={{left: "0px", bottom: "0px"}}><div className="ps__thumb-x" tabindex="0" style={{left: "0px", width: "0px"}}></div></div><div className="ps__rail-y" style={{top: "0px", height: "678px", right: "0px"}}><div className="ps__thumb-y" tabindex="0" style={{top: "0px", height: "592px"}}></div></div></div>
